...
function fn(arr, cash) {
  ...
  arr.forEach(bayer => {
    ...
    //до якої каси відноситься мінімальне значення
    const currentCase = values.indexOf(minValue) + 1; //омпенсуємо різницю, так як індекс починає відлік з нуля, а каси з 1
